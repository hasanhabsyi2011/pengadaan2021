    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">    
          ...
          <!-- ===== Pesan error dan sukses dibuat di sini pakai alert dari bootstrap (dicopy dari webnya, keyword cari di google: alert bootstrap) ====== -->


          <!-- baca variabel yang dikirim dari controller (file Registrasi.php) -->
