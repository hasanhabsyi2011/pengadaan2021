...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <!-- ini akan letakan include di sini-->
      @include('utama.menu');
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <h2>Kami memberikan kesempatan kepada UMKM yang ingin mengajukan berang atau jasa yang dimiliki</h2>
          <div class="d-flex justify-content-center justify-content-lg-start">

            <!-- muncul atau menghilangkan menu btn Dafar Sekarang-->            
            @if($token == "kosong")
            <!-- tampilkan menu Daftar Sekarang -->
            ...
            @endif
            <!--AKHIR  muncul atau menghilangkan menu btn Dafar Sekarang -->
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>KETENTUAN</h2>
          <p>Untuk dapat mengajukan pengajuan barang dan jasa, peserta harus sesuai kulaifikasi berikut ini</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in" data-aos-delay="400">
            <div class="icon-box">
              ...
              <h4><a href="">Mmeiliki Rekening Perusahaan</a></h4>
              <p>Untuk rekening usaha wajib terpisah dari rekening privadi, dan untuk bank yang terdaftar wajib BUMN</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            ...
            <!-- mengilangkan tombol ketika sudah terdaftar -->
            @if($token == "kosong")
            ...
            @endif
            <!--AKHIR mengilangkan tombol ketika sudah terdaftar -->
