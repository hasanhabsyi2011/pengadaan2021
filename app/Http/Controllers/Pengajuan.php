...
class Pengajuan extends Controller
{
    ...
    public function pengajuan(){
        ...
        if($tokenDb > 0){
            ...
            return redirect('/masukAdmin')->with('gagal','Anda siakan login dahulu');
    ...
    public function tambahPengajuan(Request $request){
        ...
        if ($tokenDb > 0) {
            ...
            [                
                ...
                'proposal' => 'required|mimes:pdf|max:1000',
                'anggaran' => 'required' 
...
public function tambahLaporan(Request $request){
        ...
        if ($tokenDb > 0) {
            ...
            [                
                ...
                'laporan' => 'required|mimes:pdf|max:1000',
            ...
            if(M_Laporan::create(
                ...
                return redirect('/riwayatku')->with('gagal','Laporan Gagal Diuploadn');
